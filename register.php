...
if(isset($_GET["register"])) {
    ...
    if ($passwort != $passwort_abgleich) {
        header("Location: register.php?error1"); #Passwörter stimmen nicht überein
    }
    ...
    $befehl = mysqli_query($verbindung, "insert into Benutzer values (NULL, '$benutzername', '$vorname', '$nachname', '$passwort');");
...
<?php if(isset($_GET["error1"])) {
    echo "<h3 stlye='color: red;'>Die Passwörter stimmen nicht überein.</h3>"; } else if(isset($_GET["error2"])) {
